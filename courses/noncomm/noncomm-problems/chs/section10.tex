...
\begin{exr}[title=Proposition 10.2]
...
\nq
\begin{exr}[title=Proposition 10.9]
	Prove that the following are equivalent for
	a proper ideal $P$ in a ring $R$. \vspace{-0.2in}
	\begin{enumerate}[i)]
