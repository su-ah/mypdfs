...
\begin{prop}[type=Exercise,num=1d)]
...
\nq
\begin{exr}[title=Proposition 1.17]
...
\begin{exr}[title=Proposition 1.22]
...
\begin{exr}
	Determine whether the ring $\begin{bmatrix} \bQ & \bQ \\ 0 & \bZ \end{bmatrix}$ is left/right noetherian/artinian.
\end{exr} \
...
\begin{exr}
	Determine whether the ring $\begin{bmatrix} \bR & \bR \\ 0 & \bQ \end{bmatrix}$ is left/right noetherian/artinian.
\end{exr} \
