...
\includeonly{%
	...
	%chs/2-maps,
	%chs/3-submflds,
	%chs/4-tangents-fields,
	%chs/5-flow,
	%chs/6-forms-integration,
	chs/7-stokes-poincare,
}
...
\include{chs/3-submflds}

\include{chs/4-tangents-fields}

\include{chs/5-flow}

\include{chs/6-forms-integration}

\include{chs/7-stokes-poincare}
