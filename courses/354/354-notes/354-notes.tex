...
\def\coursecode{MAT354}
\def\coursename{Complex Analysis} % use \relax for non-course stuff
...
\def\sourceauthor{Prof. Nadya Askaripour} % for class notes, put lecturer
